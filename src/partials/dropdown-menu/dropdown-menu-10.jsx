...
export function DropdownMenu10({ trigger, rowID }) {
  ...
  return (
    <DropdownMenu>
      ...
      <DropdownMenuContent className="w-[180px]" side="bottom" align="end">
        ...
        <DropdownMenuItem asChild>
          {/* <div onClick={(e) => { e.stopPropagation(); navigate(`/admin/leads/other-info"${rowID}`);}}> */}
          <div onClick={(e) => { e.stopPropagation(); navigate(`/admin/leads/edit`);}}>
            <FileInput />
            <span>Edit</span>
          </div>
        </DropdownMenuItem>
