...
const LicensingInfo = () => {
  ...
  const handleAutoFetch = async () => {
    ...
    try {
      ...
      const state = await getCountytByStateId();
  ...
  const submitCreate = async () => {
    ...
    try {
      const formData = {
        ...
        other_licensed_states_id: data.other_licensed_states_id,
  ...
  const submitUpdate = async () => {
    ...
    try {
      ...
      formData.append("resident_license_state_id", selectedState);
        ...
        <Table className="align-middle text-sm text-muted-foreground">
          <TableBody>
            <TableRow>
              ...
              <TableCell className="py-3 text-secondary-foreground text-sm font-normal">
                <input type="text" value={data.social_security_number ?? 'N/A'} name='social_security_number' onChange={handleChange} />
              </TableCell>
            </TableRow>
            <TableRow>
              <TableCell className="py-3 text-secondary-foreground font-normal">
            ...
            <TableRow>
              ...
              <TableCell className="py-3 text-secondary-foreground text-sm font-normal">
                <input type="text" value={data.other_licensed_states_id ?? 'N/A'} name='other_licensed_states_id' onChange={handleChange} />
              </TableCell>
            </TableRow>
            <TableRow>
              <TableCell className="py-3 text-secondary-foreground font-normal">
